...
def mean(total_weight, total_entries):
    ...
    print("Average weight of 18 year olds is", mean, 'in pounds')
    print('Mean is the average of a given set of numbers')
...
def median(total_entries, sorted_data):
    ...
    print('Median is the number most in between in a given set  of numbers')
...
def mode(sorted_data):
    ...
    print('Mode is the most occured number in a given set of numbers')
...
input = input('What Do You Want To Know? a for Mean, b for Median, c for Mode')
